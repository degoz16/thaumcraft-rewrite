...
public class ThaumcraftPlacedFeatures {
    public static final DeferredRegister<PlacedFeature> PLACED_FEATURES =
            DeferredRegister.create(Registry.PLACED_FEATURE_REGISTRY, Thaumcraft.MOD_ID);


    public static final RegistryObject<PlacedFeature> CRYSTAL_PLACED = PLACED_FEATURES.register("crystal_placed",
            () -> new PlacedFeature(ThaumcraftConfiguredFeatures.CRYSTAL.getHolder().get(),
